...
export default function ProcessingFeeStep() {
    ...
    useEffect(() => {
        const loadExistingData = async () => {
            ...
            try {
                ...
                const hasProcessingFee = application.processingFee && application.processingFee.public_id;
                setIsReadOnly(hasProcessingFee && newStatus !== 'REJECTED');
                console.log('isReadOnly set to:', hasProcessingFee && newStatus !== 'REJECTED');
                ...
                if (hasProcessingFee) {
                    ...
                    if (newStatus === 'APPROVED') {
                        const event = new CustomEvent('processingFeeSubmitted', { detail: { isValid: true, stepId: 5 } });
                        window.dispatchEvent(event);
                        console.log('Dispatched processingFeeSubmitted event:', { isValid: true, stepId: 5 });
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const event = new CustomEvent('processingFeeSubmitted', { detail: { isValid: false, stepId: 5 } });
            window.dispatchEvent(event);
            console.log('Dispatched processingFeeSubmitted event:', { isValid: false, stepId: 5 });
        } catch (error: any) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-purple-50 to-pink-100 py-6 sm:py-8 lg:py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 transform hover:scale-101 transition-all duration-300">
                ...
                <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 text-center leading-relaxed">
                    This fee covers the initial processing and verification of your loan application. It includes document verification, credit checks, and administrative costs.
                </p>
                ...
                <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 sm:p-6 rounded-xl mb-4 sm:mb-6 border border-gray-200">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-blue-600 mb-2 sm:mb-4">Amount to Pay: ₹2500</p>
                </div>
