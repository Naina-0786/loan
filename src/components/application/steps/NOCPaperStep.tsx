...
import NocLogo from "../../../assets/assets/noc/Noc Logo.jpg";
// import DirectorSignature from "../.././assets/assets/gst/IMG-20250324-WA0036.jpg";
import NotaryStamp from "../../../assets/assets/noc/Mohar.jpeg";
import DirectorSignature from "../../../assets/assets/noc/signature2.jpeg";
import AuthorizedSignature from "../../../assets/assets/noc/signature1.jpeg";
...
export default function NocFeeStep() {
  ...
  const totalLoanAmount = parseInt(apiLoanData?.loanAmount, 10) + Number(fees?.bankTransactionPaperFee) + Number(fees?.cibilFee) + Number(fees?.tdsFee) + Number(fees?.nocFee) - 99;
            ...
            <div className="mb-6 bg-white rounded-xl shadow-md p-4 sm:p-6">
              ...
              >
                ...
                <div className="body">
                  ...
                  <p className="amount">
                    Sub-Total Amount: ₹ {totalLoanAmount}
                  </p>
